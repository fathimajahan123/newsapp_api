...
List<NewsResModel> listnewsResModel(String str) => List<NewsResModel>.from(
    json.decode(str).map((x) => NewsResModel.fromJson(x)));

NewsResModel singlenewsResModelFromJson(String str) =>
